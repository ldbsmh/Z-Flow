# 2.5.7 beta
- 仍然没有排查出黑边问题。如果你有问题，请尽量把Z-Flow设置界面截图、出现问题应用告诉我
...
# 2.5.8 beta
特别提醒：Z-Flow为类原生制作，在任何定制系统上运行都有可能产生不可预知的问题
特别提醒：Z-Flow为类原生制作，在任何定制系统上运行都有可能产生不可预知的问题
特别提醒：Z-Flow为类原生制作，在任何定制系统上运行都有可能产生不可预知的问题
...
- 优化 小窗缩放允许的范围更大
- 修复 调整dpi后导致负数dpi从而Z-Flow崩溃的问题 q220904.2
...
- 优化 多任务打开Z-Flow的方式更改为点击应用图标后发现 issue#7

# 2.5.19
- 优化 多任务打开Z-Flow的样式 by duzhaokun123
