...
class PermissionActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun checkShizukuPermission(): Boolean {
        ...
        if (result) {
            ...
            binding.content.textViewShizukuServiceInfo.text = getString(R.string.service_start)
        } else {
            ...
            binding.content.textViewShizukuServiceInfo.text = getString(R.string.service_no_start)
        }
        return result
    }
